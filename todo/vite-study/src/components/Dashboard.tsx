...
export default function Dashboard({ userId, onNavigateToHistory }: DashboardProps) {
    ...
    const [calendarViewDate, setCalendarViewDate] = useState<Date>(new Date()); // Track the month being viewed
